...
namespace Nexus\Interpreter\Expression\NonTerminal\Logical;
...
class NotExpression extends AbstractExpression
{
    ...
    protected function optimizeExpression(): Expression
    {
        ...
        if ($this->expression instanceof \Nexus\Interpreter\Expression\Terminal\LiteralExpression) {
            $val = $this->expression->getValue();

            return new \Nexus\Interpreter\Expression\Terminal\LiteralExpression(! $val);
        }
