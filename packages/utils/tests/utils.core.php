...
echo "5. extract (JSON) : " . (Utils::extractNotificationValue($json) === "Le lave-linge est fini" ? "OK" : "FAIL") . "\n";

$raw = 'Ceci est une valeur directe sans json';
echo "6. extract (RAW) : " . (Utils::extractNotificationValue($raw) === $raw ? "OK" : "FAIL") . "\n";
