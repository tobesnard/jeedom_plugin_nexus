...
class EventExpression extends AbstractExpression
{
    ...
    public function interpret(RuleContext $context = null)
    {
        ...
        if ($this->commandExpression instanceof \Nexus\Interpreter\Expression\Terminal\CmdByStringExpression) {
        ...
        } elseif ($this->commandExpression instanceof \Nexus\Interpreter\Expression\Terminal\CmdByIdExpression) {
