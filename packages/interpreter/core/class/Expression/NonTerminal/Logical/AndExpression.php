...
class AndExpression extends AbstractExpression
{
    ...
    protected function optimizeExpression(): Expression
    {
        ...
        if ($this->left instanceof \Nexus\Interpreter\Expression\Terminal\LiteralExpression) {
            ...
            if ($leftVal === false) {
                return new \Nexus\Interpreter\Expression\Terminal\LiteralExpression(false);
            }
            if ($leftVal === true) {
                return $this->right;
            }
        ...
        if ($this->right instanceof \Nexus\Interpreter\Expression\Terminal\LiteralExpression) {
